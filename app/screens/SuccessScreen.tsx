      ...
      <View style={styles.content}>
        ...
        <View style={styles.statsContainer}>
          <View style={styles.statCard}>
            ...
            <Text style={styles.statValue}>{sentPackCount}</Text>
            <Text style={styles.statLabel}>PACKS{"\n"}SENT</Text>
          </View>
          <View style={styles.statCard}>
        ...
        <View style={styles.packListItem}>
          ...
          <View style={styles.packListCenter}>
            ...
            >
              ...
              <Text style={styles.lastUpdatedText}>Successfully exported</Text>
            </View>
          </View>
